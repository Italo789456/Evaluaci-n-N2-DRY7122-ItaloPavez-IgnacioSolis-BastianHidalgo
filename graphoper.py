...
def obtener_coordenadas(ciudad):
    ...
    params = {
        "q": ciudad,
        "key": "fbbad2fe-6a1b-4aaf-95be-6a696c33715a"
    }
...
def obtener_ruta(ciudad_origen, ciudad_destino):
    try:
        ...
        print(f"ERROR, RUTA NO ENCONTRADA: {e}")
        return None
...
def main():
    while True:
        print("\nMenú:")
        print("1. Calculo distancia Santiago Puerto Varas")
        print("2. Ruta entre 2 ciudades")
        print("q. Salir")
